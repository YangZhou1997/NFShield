...
void init_nfs_once() {
    ...
    char* nf_names_all[8] = {"l2_fwd", "acl_fw", "dpi", "lpm", "maglev", "monitoring", "nat_tcp_v4", "mem_test"};    
    int (*nf_init_all[8])() = {l2_fwd, acl_fw, dpi, lpm, maglev, monitoring, nat_tcp_v4, mem_test};
    void (*nf_process_all[8])(uint8_t *) = {l2_fwd_init, acl_fw_init, dpi_init, lpm_init, maglev_init, monitoring_init, nat_tcp_v4_init, mem_test_init};
    void (*nf_destroy_all[8])() = {l2_fwd_destroy, acl_fw_destroy, dpi_destroy, lpm_destroy, maglev_destroy, monitoring_destroy, nat_tcp_v4_destroy, mem_test_destroy};
