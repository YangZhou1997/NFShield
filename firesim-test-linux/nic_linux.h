...
static inline uint32_t nic_counts(void) { return reg_read32(NIC_COUNTS); }
...
static inline void nic_complete_send(void) { reg_read16(NIC_SEND_COMP); }
...
static inline uint64_t nic_macaddr(void) { return reg_read64(NIC_MACADDR); }
